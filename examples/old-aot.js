...
let context = Context(); // NOTE: this became ENV?
let component = Compilable(source); // NOTE: This become setComponentTemplate(templateFactory, Component)
let handle = component.compile(context); // NOTE: this this needed?

let program = artifacts(context);

let document = createHTMLDocument();
let runtime = AotRuntime(document, payload); // what is payload?
